...
describe('Button', () => {
  it('renders with default props', () => {
    ...
    expect(button).toHaveClass(
      'rounded-lg px-6 py-4 text-center font-bold transition-all duration-300 ease-in-out leading-tight tracking-[0.5px] border border-transparent bg-neutral-dark text-white hover:opacity-50 w-full'
    )
  })
  ...
  it('renders secondary variant correctly', () => {
    ...
    expect(button).toHaveClass(
      'rounded-lg px-6 py-4 text-center font-bold transition-all duration-300 ease-in-out leading-tight tracking-[0.5px] border border-primary text-primary hover:bg-neutral-dark hover:text-white w-full'
    )
  })
