...
const AddToCart = dynamic(
  async () => await import('@/components/atoms/add-to-cart-btn').then((mod) => mod.default),
  {
    ssr: false,
...
export default function GameCard ({ game }: GameCardProps) {
  return (
    <div className="p-6 border-[0.5px] border-stroke-alternative bg-white-primary rounded-2xl flex flex-col justify-between gap-5">
      <div>
